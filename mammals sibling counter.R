### ### ### ### 
### Code for establishing sibling numbers from mammalian parent lists 
### associated with paper on "Human monogamy in mammalian context"
### ### ### ### 

require(stringr)

## Deposit the mammalian csv datasets in a folder containing only these files and set working directory to that folder 
...
for(z in 1:length(items)){ # loop through each dataset
  ...
  for(i in 1:nrow(dataset)){ # iterate through offspring pairs and count sibling frequencies 
